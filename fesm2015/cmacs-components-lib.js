...
class CmacsGridComponent {
    ...
    onCheckboxChange(event) {
        /** @type {?} */
        let dataSelectd = this.checkboxCache.filter((/**
         * @param {?} item
         * @return {?}
         */
        item => item.selected));
         ...
         * @return {?}
         */
        item => item.selected)).length > 0 && !this.allChecked;
        /** @type {?} */
        const dataSelectdEmit = [];
        dataSelectd.forEach((/**
         * @param {?} element
         * @return {?}
         */
