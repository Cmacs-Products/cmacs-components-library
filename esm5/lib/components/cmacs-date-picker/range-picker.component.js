...
var CmacsRangePickerComponent = /** @class */ (function (_super) {
    ...
    CmacsRangePickerComponent.decorators = [
        { type: Component, args: [{
                    ...
                    styles: [".cmacs-open-date-title{font-size:12px;font-weight:600;margin-bottom:10px}.cmacs-open-range-picker:hover .ant-calendar-range-picker-input{color:transparent}.cmacs-open-range-picker:hover .ant-calendar-picker-clear{opacity:0;display:none}.cmacs-open-date-subtitle{font-size:12px;color:#acb3bf;margin-bottom:10px}.cmacs-open-date-picker-placeholder{font-size:12px;font-weight:600;color:#acb3bf}.cmacs-open-date-picker-selected-value{color:#2a7cff}.cmacs-open-date-picker:hover .ant-calendar-picker-clear{opacity:0}.cmacs-open-range-picker-left,.cmacs-open-range-picker-right{display:inline-block}.cmacs-open-range-picker-right{float:right}.cmacs-open-range-picker-left{float:left}.ant-calendar-picker-input{box-shadow:none}.ant-calendar-picker:hover .ant-calendar-picker-input:not(.ant-input-disabled){border-color:#bec4cd;color:#bec4cd}.ant-calendar-date{padding-top:2px}.ant-calendar-today:not(.ant-calendar-selected-day):not(.ant-calendar-disabled-cell) .ant-calendar-date{display:-ms-grid;display:grid;background-color:transparent;border-color:transparent;color:rgba(0,0,0,.65)}.ant-calendar-today:not(.ant-calendar-selected-day):not(.ant-calendar-disabled-cell) .ant-calendar-date::after{content:'\u25CF';color:#2a7cff;margin-top:-9px;font-size:10px}.ant-calendar-selected-day:not(.ant-calendar-disabled-cell) .ant-calendar-date{color:#fff!important;background-color:#2a7cff!important;border-color:#2a7cff}.ant-calendar-cell.ng-star-inserted>.ant-calendar-date{width:30px;height:30px}.ant-calendar-header{margin-top:17px;margin-bottom:17px;border:none;height:17px;line-height:17px}.ant-calendar-header a{line-height:17px!important}.ant-calendar th{padding-top:0;padding-bottom:12px}.ant-calendar-date:hover{background-color:#f6f7fb}.ant-calendar-picker-icon{color:#656c79;cursor:pointer}.ant-calendar-picker i svg{height:16px;width:16px}.ant-calendar-picker-clear,.ant-calendar-picker-icon{width:16px;height:16px}.ant-calendar-disabled-cell.ant-calendar-today .ant-calendar-date::before{width:30px;height:30px;left:0}.cmacs-timeline-range-popup calendar-footer{display:none}.ant-calendar-disabled-cell.ant-calendar-selected-day .ant-calendar-date::before{position:absolute;top:-1px;left:-1px;width:30px;height:30px}"]
                }] }
    ];
    /** @nocollapse */
